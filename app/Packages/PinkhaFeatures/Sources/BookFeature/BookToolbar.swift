...
/// Notion-style toolbar pinned above the book body. Five action
...
public struct BookToolbarView: View {
                ...
                Section {
                    Button(role: .destructive) {
                        ...
                        Label {
                            ...
                            // sort pickers in LibraryView+Sort. Pre-bake
    ...
    private func dateSortRow(_ title: LocalizedStringKey, icon: String,
                             kind: BookViewModel.DateSortKind,
